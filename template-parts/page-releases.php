...
$max_page = getPostsCountPage('releases', 'release', MAX_COUNT_RELEASES_POSTS);

if (!isset($current_page) || $current_page > $max_page) $current_page = 1;

$release_arr = getPosts('releases', 'release', MAX_COUNT_RELEASES_POSTS, $current_page);
...
<h1 class="page_title">releases</h1>
